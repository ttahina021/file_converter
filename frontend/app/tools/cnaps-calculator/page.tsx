...
export default function CnapsCalculatorPage() {
  ...
  return (
    <main className={styles.main}>
      <div className={styles.container}>
        <h1 className={styles.title}>Calcul CNAPS</h1>
        <p className={styles.description}>Calculez les cotisations CNAPS</p>
        ...
        {result && (
          <div className={styles.resultsBox}>
            ...
            <div className={styles.resultItem}>
              <span className={styles.resultLabel}>Total CNAPS :</span>
